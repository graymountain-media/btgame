...
class InstructionsViewController: UIViewController {
    ...
    func setupContainerView() {
        ...
        instructionsTextView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 0).isActive = true
        instructionsTextView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 15).isActive = true
        instructionsTextView.bottomAnchor.constraint(equalTo: dismissButton.topAnchor, constant: 0).isActive = true
        instructionsTextView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -15).isActive = true
        
        dismissButton.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        dismissButton.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -8).isActive = true
